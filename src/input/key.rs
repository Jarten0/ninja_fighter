...
pub struct Key {
    pub kycode: StringifiableKeyCode,
    pub name: &'static str,
    pub status: KeyStatus,
}

impl Key {
    pub fn new(name: &'static str, kycode: StringifiableKeyCode) -> Self {
        Self {
            kycode,
            name,
...
impl Default for Key {
    fn default() -> Self {
        Self {
            kycode: StringifiableKeyCode { 0: KeyCode::Z },
            name: "None",
            status: Default::default(),
        }
    }
...
impl ToString for Key {
    fn to_string(&self) -> String {
        ...
        output.push_str(&self.kycode.to_string());

        output
    }
}

pub struct StringifiableKeyCode(KeyCode);
...
impl FromStr for StringifiableKeyCode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let mut hash_map: HashMap<&str, KeyCode> = HashMap::new();
